...
const Home = () => {
  return (
    <div className=' flex flex-col justify-center items-center bg-HomeMobile md:bg-HomeDesktop bg-center bg-no-repeat bg-cover p-6 h-screen' >
      <section className='flex flex-col lg:flex-row lg:items-center justify-around lg:justify-center h-[80vh]   m-4' >
        ...
        <article className=' text-center lg:w-1/2'>
          <button className='font-Bellefair bg-white text-black w-52 h-52 lg:w-72 lg:h-72 rounded-full text-2xl lg:text-4xl hover:shadow-boxshadow cursor-pointer' >
